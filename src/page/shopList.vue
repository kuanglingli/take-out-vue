                ...
                <el-table-column label="操作" width="200">
                  <template slot-scope="scope">
                    ...
                    <el-button
                      ...
                      v-if="scope.row.isEffect=='1'">编辑</el-button>
                    <el-button
                      size="mini"
                      type="Success"
                      @click="addFood(scope.$index, scope.row)"
                      v-if="scope.row.isEffect=='1'">添加商品</el-button>
                    <!-- <el-button
                      size="mini"
                      type="danger"
            ...
            <el-dialog title="修改店铺信息" v-model="dialogFormVisible">
                <el-form :model="selectTable">
                    <el-form-item label="店铺名称" label-width="100px">
                        <el-input v-model="selectTable.shopName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="详细地址" label-width="100px">
                      <el-input v-model="selectTable.shopAddress" auto-complete="off"></el-input>
                        <!-- <el-autocomplete
                    ...
                    <el-form-item label="店铺介绍" label-width="100px">
                        <el-input v-model="selectTable.shopDesc"></el-input>
                    </el-form-item>
                    <el-form-item label="联系电话" label-width="100px">
                        <el-input v-model="selectTable.shopTel"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="商铺图片" label-width="100px">
                        <el-upload
                          ...
                          <img v-if="selectTable.shopImgUrl" :src="baseImgUrl+selectTable.shopImgUrl" class="avatar">
    ...
    export default {
      ...
      $route(){
        ...
        methods: {
          ...
          addFood(index, row){
              localStorage.setItem('restaurant_id',row.shopId);
              this.$router.push({ path: 'addGoods', query: { restaurant_id: row.shopId }})
          },
          ...
          handleServiceAvatarScucess(res) {
            if (res) {
                this.selectTable.shopImgUrl = res;
            }else{
          ...
          setEffect(index, row,isEffect){
            this.$axios({
              method: "post",
              url: "/shiro/shop-do/setEffect",
              data: {
                id:row.id,
                isEffect:isEffect
              },
